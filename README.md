...
Las UNIDADES del TEMA actual (**3. JavaScript profesional en una aplicación web**) junto con los ejercicios son los siguientes:

| UNIDAD | Enunciados | Ejercicios |
| -------- | ---------- | ---------- |
| 1. Trabajo avanzado con el DOM                | [u1e1](u1/u1e1.md), [u1e1](u1/u1e2.md) | [u1e1](u1/u1e1.js), [u1e1](u1/u1e2.js) |
| 2. Delegación de eventos                      | [u2e1](u2/u2e1.md) | [u2e1](u2/u2e1.js) |
| 3. Eventos personalizados (custom events)     | [u3e1](u3/u3e1.md) | [u3e1](u3/u3e1.js) |
| 4. Almacenamiento local usando Cookies        | [u4e1](u4/u4e1.md) | [u4e1](u4/u4e1.js) |
| 5. API Disponibles en el navegador            | [u5e1](u4/u5e1.md) | [u5e1](u4/u5e1.js) |
